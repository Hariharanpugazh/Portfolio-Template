            ...
            <ul className='flex  w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5'>
                {links.map(link => (
                    <motion.li
                        ...
                        key={link.hash}>
                        <Link className={clsx('flex w-full items-center justify-center px-3 py-3 hover:text-gray-950 transition dark:text-gray-500 dark:hover:text-gray-200', { "text-gray-950  dark:text-gray-100": link.name === activeSection })} href={link.hash}
                            onClick={() => {
                        ...
                        >
                            ...
                            {link.name === activeSection &&
                                <motion.span layoutId='activeSection' transition={{
                                    ...
                                    stiffness: 380,
                                    damping: 30
                                }} className='bg-gray-100 absolute inset-0 -z-10 rounded-full dark:bg-gray-800'></motion.span>
                            }
                        </Link>
